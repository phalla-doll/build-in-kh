    ...
    <div className="min-h-screen bg-white text-zinc-900 selection:bg-pink-500 selection:text-white">
      ...
      <main className="container mx-auto px-4 py-24 md:px-6">
        ...
        <div className="mb-16 flex flex-col items-center text-center">
          <div className="mb-6 h-32 w-32 overflow-hidden rounded-full border-2 border-zinc-200 bg-zinc-50">
            <Image
              src={creator.avatar}
              alt={creator.name}
              width={128}
          ...
          <h1 className="mb-2 font-display text-4xl font-bold tracking-tight text-zinc-900">{creator.name}</h1>
