        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-12">
          <div className="max-w-sm">
             <Link href="/" className="flex items-center gap-3 mb-6 group w-fit">
                <div className="border-2 border-black bg-neon-lime p-1 shadow-[2px_2px_0px_0px_rgba(255,255,255,0.2)] transition-transform group-hover:-translate-y-0.5 group-hover:shadow-[4px_4px_0px_0px_rgba(255,255,255,0.2)]">
                   <Logo className="h-8 w-8" />
                </div>
                <div className="flex flex-col leading-none">
                   <span className="font-mono text-[10px] font-bold uppercase tracking-widest text-zinc-400">Built In</span>
                   <span className="font-display text-xl font-black tracking-tighter text-white uppercase">Cambodia</span>
                </div>
             </Link>
